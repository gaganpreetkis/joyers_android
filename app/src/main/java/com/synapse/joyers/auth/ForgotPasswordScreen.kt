...
fun ForgotPasswordScreen(
    ...
    // Form validation
    val isFormValid = remember(username, phone, isPhoneMode.value) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            // Description text
            Text(
                text = if (showVerificationCode) if (isPhoneMode.value) {
            ...
            // Error messages
            if (phoneError != null && isPhoneMode.value) {
                Text(
                    text = phoneError!!,
                    color = Red,
                    fontSize = 14.sp,
            ...
            if (usernameError != null && !isPhoneMode.value) {
                Text(
                    text = usernameError!!,
                    color = Red,
                    fontSize = 14.sp,
