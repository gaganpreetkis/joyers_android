...
class UploadPictureServerUseCase @Inject constructor(
    private val profileRepository: ProfileRepository
) {
    suspend operator fun invoke(imageId: Int, imagePath: String): Result<UploadPictureServerResponse> {

        return profileRepository.uploadPictureServer(imageId, imagePath)
